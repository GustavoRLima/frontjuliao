...
import { competidorService } from '@/services/api.service'
...
const fetchProfile = async () => {
  try {
    ...
    const response = await competidorService.getMe()
...
const handleSubmit = async (formData: FormData) => {
  try {
    ...
    const response = await competidorService.edit(formData)
...
<template>
  <div class="athlete-edit py-5">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-10">
          <div class="card shadow">
            <div class="card-header bg-success text-white">
              <h3 class="mb-0">{{ t('athlete.editTitle') }}</h3>
            </div>
